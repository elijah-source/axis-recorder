...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, FlaskConical, Share2 } from 'lucide-react';
...
const TABS = [
  ...
  { value: 'integrations', label: 'Integrations', icon: Share2 },
